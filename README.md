...
1. Inputs
   1. Databases
      1. [Snowflake Custom Query](#InputsDatabasesSnowflake-custom-query)
      2. [MongoDB](#InputsDatabasesMongoDB)
   2. R
...
4. Preparation
   ...
   10. [Anonymise](#PreparationAnonymise)
   11. [Streaming Field Renamer](#PreparationStreaming-Field-Renamer)
   12. [URL Encode](#PreparationURL-Encode)
   13. [Field Renamer](#PreparationField-Renamer)
   14. [Centroids from GeoJSON](#PreparationGeoCentroids)
   15. [Sort fields](#PreparationSort-fields)
   16. [Conditional Execution](#PreparationConditionalExecution)
   17. [Unstack Records](#PreparationUnstack-rows)
...
5. Outputs
   ...
   3. PDF
      1. [Multi-tenant Report to PDF](#OutputsReport-to-PDF-batch-output)
