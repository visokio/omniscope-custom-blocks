...
3. Preparation
   ...
   11. [Unescape HTML](#PreparationUnescape-HTML)
   12. [Add row ID field](#PreparationAdd-row-ID-field)
   13. [Markdown to HTML](#PreparationMarkdown-to-HTML)
   14. [Streaming Field Renamer](#PreparationStreaming-Field-Renamer)
   15. [Unstack Records](#PreparationUnstack-rows)
   16. [Split Address](#PreparationSplit-Address)
   17. [Field Renamer](#PreparationField-Renamer)
   18. [Centroids from GeoJSON](#PreparationGeoCentroids)
   19. [Sort fields](#PreparationSort-fields)
   20. [URL Encode](#PreparationURL-Encode)
4. Outputs
   1. BigQuery
