...
1. Preparation
   ...
   5. Join
      ...
      3. [Interval Join](#PreparationJoinIntervalJoin)
   6. Partition
...
3. Connectors
   ...
   7. [Etherscan](#ConnectorsEtherscan)
   8. [Yahoo Finance](#ConnectorsYahooFinance)
   9. [Jira](#ConnectorsJira)
   10. [XPT Reader](#ConnectorsXPTReader)
   11. [Google BigQuery Import Table](#ConnectorsBigQueryGoogleBigQueryImportTable)
